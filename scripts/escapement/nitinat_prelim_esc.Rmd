...
Low water was a migration barrier and likely meant sockeye were much more visible to surveyors later in the season than usual (they were prevented from migrating further upstream to Parker Creek); 2023 estimate may be much higher than previous years. An AUC estimate may be considered as we know we saw the same ~300 fish over 3-4 surveys. AUC estimate using longer survey life 30-40 days is ~500 adults.  *This is subject to change; see EscBatchHardCopy report for specific estimate abundance.*
...
For 2023 suggest AUC with short SL (8-15 days),  mid value = ~27,530 and subtract swim-ins for the accounting (6201) leaves ~21,329 chum.
