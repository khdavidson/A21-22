...
ggplot()  +
  geom_bar(data=nit.escHistorical %>% 
             filter(`Waterbody Name` %in% c("NITINAT RIVER", "WORTHLESS CREEK", "NONAME CREEK", "JASPER CREEK", 
                                            "LITTLE NITINAT RIVER", "PARKER CREEK"), `Species Qualified`=="PKE"), 
           aes(x=`Analysis Year`, y=`Natural Adult Spawners`), stat="identity", colour="dodger blue", fill="dodger blue", alpha=0.8) +
  geom_bar(data=nit.escHistorical %>%  
             filter(`Waterbody Name` %in% c("NITINAT RIVER", "WORTHLESS CREEK", "NONAME CREEK", "JASPER CREEK", 
                                            "LITTLE NITINAT RIVER", "PARKER CREEK"), `Species Qualified`=="PKE"), 
