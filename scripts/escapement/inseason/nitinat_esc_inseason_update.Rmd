...
ggplot() +
  ...
  geom_bar(data=nitinat.SIL %>% 
           ...
           aes(x=date, y=total_adults, group=SBJ_ID, fill=SBJ_ID), stat="identity", alpha=0.8, width=5) +
...
ggplot() +
  ...
  geom_bar(data=nitinat.SIL %>% 
           ...
           stat="identity", alpha=0.8, width=4, size=1) +
...
ggplot() +
  geom_bar(data=nitinat.SIL %>% 
           ...
           stat="identity", position="stack", alpha=0.7, size=1, width=3) +
